...
import json
import os
import reports.reportTemplate.batch.batch_parameters as batch_parameters
from functions.database_connection_DW import mydb

# There is 3 mains files: path: reportTemplate > batch > batch_columns.json / batch_parameters.py / batch.py
# reportTeplate = ReportHeader.
# batch = ReportName folder.
# batch_columns.json = Mapping all necessary columns.
# batch_parameters.py = Set the paramaters.
# batch.py = the main file.
...
reportHeader = "reportTemplate"
reportNameFolder = "batch"
reportName = "batch"


# begin batch_columns.json
...
def load_columns_mapping():
    ...
    """       
    # Step 1 = Corrected the path to the JSON file
    json_file_path = f'reports/{reportHeader}/{reportNameFolder}/{reportName}_columns.json'  
    ...
    if os.path.exists(json_file_path):
        ...
        return {}
# end batch_columns.json

# Cache for the database connection for infeed700DW
@st.cache_resource
